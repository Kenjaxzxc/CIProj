<body id="page-top">
    ...
    <div id="wrapper">
      ...
      <form id="" method="post" enctype="multipart/form-data" action="<?php echo base_url('admin/addStudent');?>">
        <div class="container-fluid">
        	<div class="row">
        		<div class="col-md-12">
        				...
        				<div class="card shadow">
	        				...
	        				<div class="card-body">
	        					  ...
	        					  <div class="form-group">
    								    <label for="exampleFormControlFile1">Upload student's profile pic</label>
    								    <br>
                  ...
                  <div class="form-group">
                      <label for="idNo">Student's ID</label>
                      <input type="text" class="form-control" id="idNo" name="idNo" readonly value="<?=$student_id;?>" required>
                       <div class="invalid-feedback">
                          Please input student's six digit ID.
                      </div>
                  </div>
								  <div class="form-group">
								      <label for="validationCustomfirstname01">First name</label>
                            ...
                            <option value="m">Male</option>
					              ...
					              <div class="form-group">
					                ...
					                <select class="form-control" name="selectedSection">
					                  <?PHP
