        			...
        			<div class="col-md-6 mx-auto">
        				<div class="card shadow">
        					<div class="card-header">
        						<h5><li class="fa fa-plus-circle"></li> Add Subject</h5>
        					</div>
        			
	        				<div class="card-body">
	        					<form id="addSubject" method="post" action="<?php echo base_url('admin/addSubject');?>" class="needs-validation" novalidate>
                      <div class="form-group mb-5">
                          ...
                          <div class="valid-feedback">
                            That's a good subject name.
                          </div>
                           <div class="invalid-feedback">
                              Please input a subject name.
                          </div>
                      </div>
